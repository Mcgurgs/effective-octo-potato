...
def type_text2(text):            
    for char in text:
        ...
        # Intro
def intro_func():
     type_text('Hello! Thanks for joining'.center(25))
     print()
     type_text('Project #1')
     print()
     time.sleep(.03)
...
print()
print()
# user_password sliced and hides the rest of the password
type_text2(f'''             ______________________________________________________________
            |                                                                
            |{user_name.center(60)}                                           
...
if in_usa in states:
          if in_usa in states:
            ...
            if state_update:
                 ...
                 type_text('No updates have been made')
...
print()
print()
verify_input = input('Please select:|Y|-|N|').upper()
print()
print()
password_attempts = 3
...
print()         
print()         
type_text(f'Welcome to the database {user_name}! ..')
print()
print()
print()
...
type_text2(f'I hope you enjoyed this small project. Thanks again for joining, {user_name}')
print()
print()
print()
type_text2('Find me on LinkedIn or Twitter')
print()
print()
type_text2('LinkedIn: https://www.linkedin.com/in/kylermcguire/')
print()
print()
print()
type_text2('Twitter: https://twitter.com/heretolearnman')
print()
print()
time.sleep(.3)
type_text2('Cya!')
